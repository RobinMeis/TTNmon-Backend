...
rm /var/www/backend/api/dumps/ttnmon_dump-latest.sql.gz
ln -s  /var/www/backend/api/dumps/ttnmon_dump-$(date +%F).sql.gz /var/www/backend/api/dumps/ttnmon_dump-latest.sql.gz
