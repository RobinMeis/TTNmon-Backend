...
$LOG_WEBHOOK                        = FALSE; //Logs the last packet received by the webhook in log.json in /webhook. WARNING: This data is publicly accessible by default. Enable only for debugging
?>
