...
$ALLOW_MANUAL_DEVICE_REGISTRATION   = TRUE; //Disables device registration using the API. This is recommended when enabling adoption proof as the API can't perform the proof against TTN backend
?>
